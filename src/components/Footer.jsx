  ...
  return (
    <div className="container">
      <footer className="py-3 my-4">
        <ul
          className="nav justify-content-center pb-3 mb-3 text-center border-bottom-picker-contrast"
          style={{ transition: "border-color 0.15s ease-in-out" }}
        >
          <li className="nav-item">
            <a
              href="https://equity.eku.edu/equal-opportunity-statement"
              className="nav-link px-2 text-picker-contrast"
              rel="noreferrer"
              target="_blank"
            >
          ...
          <li className="nav-item">
            <a className="nav-link px-2 text-picker-contrast" href="tel:8596221000" rel="noreferrer" target="_blank">
              859-622-1000
            </a>
          </li>
        </ul>
        <p style={{ transition: "color 0.15s ease-in-out" }} className="text-center text-picker-contrast">
